...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateOnScroll = function() {
        const elements = document.querySelectorAll('.experience-item, .skill-category, .project-item');
    ...
    const animatedElements = document.querySelectorAll('.experience-item, .skill-category, .project-item');
